...
func UploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	var encryptor filespliter.Encryptor
	switch algorithm {
	case "aes-gcm":
		encryptor = filespliter.NewAESGCMEncryptor(key)
	case "aes-cbc":
		encryptor = filespliter.NewAESCBCEncryptor(key)
	default:
...
func SplitUploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	// // fileheader.Filename
	// filenum := filespliter.Split(fileheader.Filename)
